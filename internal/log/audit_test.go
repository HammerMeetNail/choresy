...
func TestAudit_LogCreated(t *testing.T) {
	...
	l, err := svc.LogChore(ctx, 5, 9, 100, nil, "done", nil, nil, nil, nil, nil, nil, nil, nil)
	if err != nil {
...
func TestAudit_LogUpdated(t *testing.T) {
	...
	l, _ := svc.LogChore(ctx, 5, 9, 100, nil, "first", nil, nil, nil, nil, nil, nil, nil, nil)
	rec.Reset()

	if err := svc.UpdateLog(ctx, l.ID, 5, nil, "edited", nil, nil, nil, nil, nil, nil, nil, nil, nil); err != nil {
...
func TestAudit_LogUpdated_CrossHouseholdNotAudited(t *testing.T) {
	...
	l, _ := svc.LogChore(ctx, 5, 9, 100, nil, "x", nil, nil, nil, nil, nil, nil, nil, nil)
	// Try to update from a different household — must fail and not be audited.
	if err := svc.UpdateLog(ctx, l.ID, 99, nil, "hacked", nil, nil, nil, nil, nil, nil, nil, nil, nil); err == nil {
