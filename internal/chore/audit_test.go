...
func TestAudit_ChoreUpdated(t *testing.T) {
	...
	if err := svc.UpdateChore(ctx, c.ID, 1, "New", "", "", "", nil, nil, nil, nil, nil); err != nil {
...
func TestAudit_ChoreUpdated_CrossHouseholdNotAudited(t *testing.T) {
	...
	if err := svc.UpdateChore(ctx, c.ID, 2, "Hacked", "", "", "", nil, nil, nil, nil, nil); err == nil {
...
func TestAudit_ChoreDefaultRestored(t *testing.T) {
	...
	_ = svc.UpdateChore(ctx, targetID, 1, "Modified", "", "", "", nil, nil, nil, nil, nil)
	rec.Reset()
