...
func TestService_CreateChore_Defaults(t *testing.T) {
	...
	c, err := svc.CreateChore(ctx, 1, 10, "My Chore", "", "", "", nil, nil, nil, "", "", nil)
	if err != nil {
		t.Fatalf("CreateChore: %v", err)
	}
	if c.Icon == "" {
...
func TestService_CreateChore_EmptyNameError(t *testing.T) {
	svc := chore.NewService(chore.NewMemoryStore())
	_, err := svc.CreateChore(context.Background(), 1, 10, "", "", "", "", nil, nil, nil, "", "", nil)
	if err == nil {
...
func TestService_ListChores_MultipleHouseholds(t *testing.T) {
	...
	_, _ = svc.CreateChore(ctx, 1, 10, "HH1 Chore", "", "", "", nil, nil, nil, "", "", nil)
	_, _ = svc.CreateChore(ctx, 2, 20, "HH2 Chore", "", "", "", nil, nil, nil, "", "", nil)
...
func TestService_GetChore(t *testing.T) {
	...
	created, _ := svc.CreateChore(ctx, 1, 10, "Cat Feeding", "🐱", "", "", nil, nil, nil, "", "", nil)
...
func TestService_UpdateChore_PartialUpdate(t *testing.T) {
	...
	c, _ := svc.CreateChore(ctx, 1, 10, "Old Name", "🐱", "#000", "cleaning", nil, nil, nil, "", "", nil)

	err := svc.UpdateChore(ctx, c.ID, 1, "New Name", "", "", "", nil, nil, nil, nil, nil, nil)
	if err != nil {
...
func TestService_UpdateChore_UpdateIndicators(t *testing.T) {
	...
	c, _ := svc.CreateChore(ctx, 1, 10, "Task", "", "", "", []string{"label1"}, nil, nil, "", "", nil)
	err := svc.UpdateChore(ctx, c.ID, 1, "", "", "", "", []string{"new1", "new2"}, nil, nil, nil, nil, nil)
	if err != nil {
		t.Fatalf("UpdateChore: %v", err)
	}
	updated, _ := svc.GetChore(ctx, c.ID)
...
func TestService_UpdateChore_NotFound(t *testing.T) {
	svc := chore.NewService(chore.NewMemoryStore())
	err := svc.UpdateChore(context.Background(), 9999, 1, "X", "", "", "", nil, nil, nil, nil, nil, nil)
	if err == nil {
		t.Fatal("expected error for missing chore")
	}
}
...
func TestService_ReorderChores(t *testing.T) {
	...
	c3, _ := svc.CreateChore(ctx, 1, 10, "C", "", "", "", nil, nil, nil, "", "", nil)
...
func TestService_RestoreDefaultChore(t *testing.T) {
	...
	_ = svc.UpdateChore(ctx, target.ID, 1, "Modified Name", "", "", "", nil, nil, nil, nil, nil, nil)
...
func TestService_RestoreDefaultChore_NotPredefined(t *testing.T) {
	...
	c, _ := svc.CreateChore(ctx, 1, 10, "Custom", "", "", "", nil, nil, nil, "", "", nil)
...
func TestService_UpdateChore_WithIconColorCategory(t *testing.T) {
	...
	c, _ := svc.CreateChore(ctx, 1, 10, "Sweep", "🧹", "#000", "cleaning", nil, nil, nil, "", "", nil)

	// Pass non-empty icon, color, and category – covers all three update branches
	err := svc.UpdateChore(ctx, c.ID, 1, "", "🫧", "#AABBCC", "hygiene", nil, nil, nil, nil, nil, nil)
	if err != nil {
		t.Fatalf("UpdateChore: %v", err)
	}
